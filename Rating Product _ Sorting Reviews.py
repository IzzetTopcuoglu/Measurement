...
df = pd.read_csv("C:/Users/izzet/PycharmProjects/DSMLBC9/DSMLBC9- Ödevler/Modül_3_Ölçümleme_Problemleri/Sorting_Scoring/amazon_review.csv")
df["overall"].mean()
...
time_based_weighted_average(df,w1=24, w2=22, w3=20, w4=18, w5=16)
df["overall"].mean()
###################################################
